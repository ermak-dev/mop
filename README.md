...
3. Собрать образ шарда — только для гипервизоров, где папет живёт в
   ...
   сборка берёт `.mop` из её файлов как лежат, без коммита и push: так
   правку манифеста можно проверить образом до влития в master. Узел объявляет, чьи образы у него есть: без
...
mop driver build [origin]  собрать образ шарда на гипервизорах (LXC); без аргумента — эта копия, её `.mop` как лежит
