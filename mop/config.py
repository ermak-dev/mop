...
OPTIONAL = {
    ...
    #
    # Пути, а не имена ролей: файл окружения папетов — часть установки
    # (setup.yaml в корне, копия setup.yaml.example), и ролевое дерево
    # ему ни к чему. Ровно поэтому же настройку не отдали
